...
u16	    FLASH_SECTOR_COUNT= 2458;	//4.8M字节,默认为W25X16  20150118 19.21 Added
...
)
{
	...
	switch(pdrv)
	{
		...
		case EX_FLASH://外部flash
			...
			//if(SPI_FLASH_TYPE==W25X16)FLASH_SECTOR_COUNT=2458;	//W25X16  20150118 19.21 Added
